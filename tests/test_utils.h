...
#define SMALL_HEAP_FLAGS_NO_RR (VIRTALLOC_FLAG_VA_DEFAULT_SETTINGS | VIRTALLOC_FLAG_VA_KEEP_SIZE_TINY | VIRTALLOC_FLAG_VA_NO_RR_ALLOCATOR)
#define SMALL_HEAP_FLAGS (VIRTALLOC_FLAG_VA_DEFAULT_SETTINGS | VIRTALLOC_FLAG_VA_KEEP_SIZE_TINY | VIRTALLOC_FLAG_VA_SMA_REQUEST_MEM_FROM_GPA)
