...
#define VIRTALLOC_FLAG_VA_KEEP_SIZE_NORMAL 0x0  // not a real setting because it's already the default
...
#define VIRTALLOC_FLAG_VA_DEFAULT_SETTINGS (VIRTALLOC_FLAG_VA_HAS_SAFETY_CHECKS | VIRTALLOC_FLAG_VA_SMA_REQUEST_MEM_FROM_GPA | VIRTALLOC_FLAG_VA_HAS_SAFETY_PADDING_LINE)
